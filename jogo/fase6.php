...
<html> 
	...
	opcao1.src = "narracao/extintor.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/luva.ogg";	

	var opcao3 = new Audio();
	opcao3.src = "narracao/ovo.ogg";
	...
	left: 40px;
	display: block; 
	text-shadow: 0px 1px 0px #228B22; 
	text-align: center; 
	border: solid 1px #228B22; 
	border-radius: 5px; 
	box-shadow: 0px 2px 3px #228B22; 
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase6.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-fire"> </span>  Fase 6 - Tá pegando fogo! </p></h3>
					</div>
					<div class="modal-body">
						<h3>Oh não! Um incêndio está acontecendo! Vamos ajudar!<br><br>
						Nessa fase você irá aprender a como ajudar alguém que está em um incêndio, e para salvar o personagem do jogo, escolha a opção correta. Mãos a obra! <br><br>
						Boa Sorte!</h3>
					</div>			
