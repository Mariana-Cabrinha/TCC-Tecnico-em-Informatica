...
<html> 
	...
	opcao1.src = "narracao/emergencia.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/flor.ogg";	
	...
	.background{
	background-image: url('imagens/Fase_4/fase4.png');
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase4.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-bed"> </span>  Fase 4 - Apagão </p></h3>
					</div>
					<div class="modal-body">
						<h3>
						Olhe! Parece que alguém desmaiou! Precisamos ajudar!<br><br>
						Nessa fase você irá aprender a como ajudar alguém que sofreu um desmaio, e para salvar o personagem do jogo escolha a opção correta! Você consegue! <br><br>
						Boa Sorte!</h3>
					</div>			
		...
		<img src="imagens/Fase_4/gif4.gif" width="210" class="gif">
		
		<?php $pontos = $_GET["pontos"]; ?>
		<form action="inserir4.php?pontos=<?php echo $pontos;?>" method="post">
			<label onmouseover="opcao1.play()">
				<div id="estilo1" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="1">
					...
					<img id="drag1" name="img1" src="imagens/Fase_4/telefone.png" draggable="false" ondragstart="drag(event)" width="125" class="imagem">
				</div>
			</label> 
			<br><br>
			<label onmouseover="opcao2.play()">
				<div id="estilo2" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="2"> 
					...
					<img id="drag2" name="img2" src="imagens/Fase_4/flor.png" draggable="false" ondragstart="drag(event)" width="120" class="imagem2"> 
				</div> 
			</label>
			<br><br>
			<label onmouseover="opcao3.play()">
				<div id="estilo3" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="3">
					...
					<img id="drag3" name="img3" src="imagens/Fase_4/chorar.png" draggable="false" ondragstart="drag(event)" width="130" class="imagem3"> 
				</div> 
			</label>
			<br><br>
