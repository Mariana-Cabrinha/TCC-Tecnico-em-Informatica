...
<html> 
	<head> 
		...
		.background{
		background-image: url('imagens/Fase_5/fase5.png');
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase1.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-flash"> </span>  Fase 1 - A faca </p></h3>
					</div>
					<div class="modal-body">
						<h3> Olá jogador!<br><br>
						Oh não! Parece que alguém se cortou! Precisamos ajudar!<br><br>
						Nessa fase você irá aprender a como ajudar alguém que sofreu um corte, e para salvar o personagem do jogo você deve escolher a opção correta! Espero que consiga salvar a criança. <br><br>
						Boa Sorte!</h3>
					</div>
		...
		<img src="imagens/Fase_5/gif5.gif" width="110" height="110" class="gif">

		<?php $pontos = $_GET["pontos"]; ?>
		<form action="inserir.php?pontos=<?php echo $pontos;?>" method="post">
			<label onmouseover="opcao1.play()">
				<div id="estilo1" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="1">
					...
					<img id="drag1" name="img1" src="imagens/Fase_5/chorar.png" draggable="false" ondragstart="drag(event)" width="125" class="imagem">
				</div>
			</label> 
			<br><br>
			<label onmouseover="opcao2.play()">
				<div id="estilo2" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="2"> 
					...
					<img id="drag2" name="img2" src="imagens/Fase_5/faca.png" draggable="false" ondragstart="drag(event)" width="160" class="imagem2"> 
				</div> 
			</label>
			<br><br>
			<label onmouseover="opcao3.play()">
				<div id="estilo3" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="3">
					...
					<img id="drag3" name="img3" src="imagens/Fase_5/curativo.png" draggable="false" ondragstart="drag(event)" width="170" class="imagem3"> 
				</div> 
			</label>
			<br><br>
