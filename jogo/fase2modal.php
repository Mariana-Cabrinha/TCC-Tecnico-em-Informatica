...
<html> 
	...
	<body class="background"> 
		...
		$compara = "SELECT Valor_Valorradio9 FROM fase_animal INNER JOIN opcao_fase_animal ON fase_animal.Valor_Valorradio9=opcao_fase_animal.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_9/fase9_ok.png" width="500" height="300" align="center" class="imagem_modal">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'fase3.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase2.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
