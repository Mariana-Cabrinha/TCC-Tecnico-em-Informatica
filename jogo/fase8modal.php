...
<html> 
	...
	<body class="background"> 
		...
		$compara = "SELECT Valor_Valorradio10 FROM fase_acidente INNER JOIN opcao_fase_acidente ON fase_acidente.Valor_Valorradio10=opcao_fase_acidente.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_10/fase10_ok.png" width="500" height="300" align="center" class="imagem_modal">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'fase9.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase8.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
