...
<html> 
	...
	<body class="background"> 
		<!-- Áudios do Jogo -->
			...
			<source src="musicas/sleep.mp3" type="audio/mp3" />
		</audio>
		...
		$compara = "SELECT Valor_Valorradio FROM fase_afogamento INNER JOIN opcao_fase_afogamento ON fase_afogamento.Valor_Valorradio=opcao_fase_afogamento.Valor_ValorCerto";
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'fase6.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase5.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
