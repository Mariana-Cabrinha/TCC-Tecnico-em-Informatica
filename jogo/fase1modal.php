...
<html> 
	...
	<body class="background"> 
		...
		<source src="musica/fundo.mp3" type="audio/mp3">
		</audio>
		...
		$compara = "SELECT Valor_Valorradio5 FROM fase_corte INNER JOIN opcao_fase_corte ON fase_corte.Valor_Valorradio5=opcao_fase_corte.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_5/fase5_ok.png" width="500" height="300" align="center" class="imagem_modal">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'fase2.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase1.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
