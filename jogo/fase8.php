...
<html> 
	...
	opcao1.src = "narracao/gelo.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/emergencia.ogg";	

	var opcao3 = new Audio();
	opcao3.src = "narracao/copoagua.ogg";
	...
	.background{
	background-image: url('imagens/Fase_10/fase10.png');
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase8.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-flash"> </span>  Fase 8 - O Acidente </p></h3>
					</div>
					<div class="modal-body">
						<h3> Veja! A menina sofreu um acidente de carro! Ela precisa de ajuda!<br><br>
						Nessa fase você irá aprender a como ajudar alguém que sofreu um acidente. Para salvar a personagem do jogo, escolha a opção correta. Vamos! <br><br>
						Boa Sorte!</h3>
					</div>			
		...
		<form action="inserir8.php?pontos=<?php echo $pontos;?>" method="post">
			<img src="imagens/Fase_10/gif.gif" width="300"class="gif">
			<label onmouseover="opcao1.play()">
				<div id="estilo1" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="1">
					...
					<img id="drag1" name="img1" src="imagens/Fase_10/opcao1.png" draggable="false" ondragstart="drag(event)" width="140" class="imagem">
				</div>
			</label> 
			<br><br>
			<label onmouseover="opcao2.play()">
				<div id="estilo2" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="2"> 
					...
					<img id="drag2" name="img2" src="imagens/Fase_10/opcao2.png" draggable="false" ondragstart="drag(event)" width="130" class="imagem2"> 
				</div> 
			</label>
			<br><br>
			<label onmouseover="opcao3.play()">
				<div id="estilo3" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="3">
					...
					<img id="drag3" name="img3" src="imagens/Fase_10/opcao3.png" draggable="false" ondragstart="drag(event)" width="65" class="imagem3"> 
				</div> 
			</label>
			<br><br>
