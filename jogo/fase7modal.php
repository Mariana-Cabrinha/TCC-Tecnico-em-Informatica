...
<html> 
	...
	<body class="background"> 
		...
		$compara = "SELECT Valor_Valorradio2 FROM fase_choque INNER JOIN opcao_fase_choque ON fase_choque.Valor_Valorradio2=opcao_fase_choque.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_2/fase2_ok.png" width="500" height="300" align="center" class="imagem_modal">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'fase8.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase7.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
