...
<html> 
	...
	opcao1.src = "narracao/cremedental.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/gelo.ogg";	

	var opcao3 = new Audio();
	opcao3.src = "narracao/lavar.ogg";
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase9.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-cutlery"> </span>  Fase 9 - Me queimei! </p></h3>
					</div>
					<div class="modal-body">
						<h3> Olhe! Parece que alguém está com uma queimadura! Vamos ajudar?<br><br>
						Nessa fase você irá aprender a como ajudar alguém que se queimou, e para salvar o personagem você deve escolher a opção correta. Só você pode ajudar! <br><br>
						Boa Sorte!</h3>
					</div>			
