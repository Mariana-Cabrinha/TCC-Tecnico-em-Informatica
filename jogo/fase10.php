...
<html> 
	...
	opcao1.src = "narracao/almofada.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/colher.ogg";	

	var opcao3 = new Audio();
	opcao3.src = "narracao/jogaragua.ogg";
	...
	.background{
	background-image: url('imagens/Fase_6/fase6.png');
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase10.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-user"> </span>  Fase 10 - Convulsionando </p></h3>
					</div>
					<div class="modal-body">
						<h3> Minha nossa! Alguém está tendo uma convulsão! O que faremos?<br><br>
						Nessa fase você irá aprender a como ajudar alguém que está tendo uma convulsão. Para salvar o personagem do jogo, escolha a opção correta. Sua ajuda é de extrema importância! <br><br>
						Boa Sorte!</h3>
					</div>			
		...
		<form action="inserir10.php?pontos=<?php echo $pontos;?>" method="post">
			<img src="imagens/Fase_6/gif6.gif" width="210" class="gif">
			<label onmouseover="opcao1.play()">
				<div id="estilo1" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="1">
					...
					<img id="drag1" name="img1" src="imagens/Fase_6/icon1.png" draggable="false" ondragstart="drag(event)" width="145" class="imagem">
				</div>
			</label> 
			<br><br>
			<label onmouseover="opcao2.play()">
				<div id="estilo2" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="2"> 
					...
					<img id="drag2" name="img2" src="imagens/Fase_6/icon2.png" draggable="false" ondragstart="drag(event)" width="93" class="imagem2"> 
				</div> 
			</label>
			<br><br>
			<label onmouseover="opcao3.play()">
				<div id="estilo3" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="3">
					...
					<img id="drag3" name="img3" src="imagens/Fase_6/icon3.png" draggable="false" ondragstart="drag(event)" width="112" class="imagem3"> 
				</div> 
			</label>
			<br><br>
