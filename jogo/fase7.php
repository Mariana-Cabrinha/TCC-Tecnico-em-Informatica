...
<html> 
	...
	opcao1.src = "narracao/lampada.ogg";	

	var opcao2 = new Audio();
	opcao2.src = "narracao/naomexa.ogg";	

	var opcao3 = new Audio();
	opcao3.src = "narracao/tomada.ogg";
	...
	.background{
	background-image: url('imagens/Fase_2/fase2.png');
	...
	<body class="background"> 
		...
		<audio autoplay id="narracao" src="narracao/fase7.ogg" onloadstart="document.getElementById('narracao').volume=0.7"></audio>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 style="color:white;"><p class="titulo-modal"><span class="glyphicon glyphicon-flash"> </span>  Fase 7 - A tomada eletrizante </p></h3>
					</div>
					<div class="modal-body">
						<h3>Oh não! Alguém está prestes a levar um choque! Precisamos agir!<br><br>
						Nessa fase você irá aprender a como agir em uma situação de choque. Para salvar a personagem do jogo você deve escolher a opção correta. Vamos lá! <br><br>
						Boa Sorte!</h3>
					</div>			
		...
		<form action="inserir7.php?pontos=<?php echo $pontos;?>" method="post">
			<img src="imagens/Fase_2/gif2.gif" width="110" class="gif">
			<label onmouseover="opcao1.play()">
				<div id="estilo1" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="1">
					...
					<img id="drag1" name="img1" src="imagens/Fase_2/lampada.png" draggable="false" ondragstart="drag(event)" width="87" class="imagem">
				</div>
			</label> 
			<br><br>
			<label onmouseover="opcao2.play()">
				<div id="estilo2" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="2"> 
					...
					<img id="drag2" name="img2" src="imagens/Fase_2/mao.png" draggable="false" ondragstart="drag(event)" width="120" class="imagem2"> 
				</div> 
			</label>
			<br><br>
			<label onmouseover="opcao3.play()">
				<div id="estilo3" class="busca" ondrop="drop(event)" ondragover="allowDrop(event)" for="3">
					...
					<img id="drag3" name="img3" src="imagens/Fase_2/tomada.png" draggable="false" ondragstart="drag(event)" width="150" class="imagem3"> 
				</div> 
			</label>
			<br><br>
