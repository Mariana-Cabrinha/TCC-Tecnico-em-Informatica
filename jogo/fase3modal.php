...
<html> 
	...
	<body class="background"> 
		...
		<form action="inserir3.php?pontos=<?php echo $pontos;?>" method="post">
			...
			$compara = "SELECT Valor_Valorradio8 FROM fase_queda INNER JOIN opcao_fase_queda ON fase_queda.Valor_Valorradio8=opcao_fase_queda.Valor_ValorCerto";
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body" align="center">
							<img src="imagens/Fase_8/fase8_ok.png" width="500" height="300" align="center" class="imagem_modal">
								...
								<script type="text/javascript">
									$(document).ready(function(){
										...
										$("#continuar").click(function(){
											window.location.href = 'fase4.php?pontos=<?php echo $pontos;?>';
										});
									});
								</script>
								...
								<script type="text/javascript">
									$(document).ready(function(){
										...
										$("#tentar").click(function(){
											window.location.href = 'fase3.php?pontos=<?php echo $pontos-5;?>';
										});
									});
								</script>
