...
<html> 
	...
	<body class="background"> 
		...
		$compara = "SELECT Valor_Valorradio6 FROM fase_convulsao INNER JOIN opcao_fase_convulsao ON fase_convulsao.Valor_Valorradio6=opcao_fase_convulsao.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_6/fase6_ok.png" width="500" height="300" align="center" class="imagem_modal">
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#continuar").click(function(){
										window.location.href = 'trofeu.php?pontos=<?php echo $pontos;?>';
									});
								});
							</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase10.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
