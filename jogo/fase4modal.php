...
<html> 
	...
	<body class="background"> 
		...
		$compara = "SELECT Valor_Valorradio4 FROM fase_desmaio INNER JOIN opcao_fase_desmaio ON fase_desmaio.Valor_Valorradio4=opcao_fase_desmaio.Valor_ValorCerto";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">
						<img src="imagens/Fase_4/Fase4_ok.png" width="500" height="300" align="center" class="imagem_modal">
						...
						<script type="text/javascript">
							$(document).ready(function(){
								...
								$("#continuar").click(function(){
									window.location.href = 'fase5.php?pontos=<?php echo $pontos;?>';
								});
							});
						</script>
							...
							<script type="text/javascript">
								$(document).ready(function(){
									...
									$("#tentar").click(function(){
										window.location.href = 'fase4.php?pontos=<?php echo $pontos-5;?>';
									});
								});
							</script>
